...
/**
 * This is the Aurorastation world.Topic() API boilerplate.
 *
 * The example implementation of the API relies on this datum system.
 * For exact details on the interserver shipping API, specifically the format
 * it uses for sending and receiving messages, please refer to the ReadMe.
 */
/datum/topic_command
