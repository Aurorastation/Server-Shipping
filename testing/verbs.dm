/*
 * A collection of verbs that were initially created to test the system.
 * After the implementation of the shipping machinery, these were no longer
 * updated. However, in most cases, they should still function.
 */
